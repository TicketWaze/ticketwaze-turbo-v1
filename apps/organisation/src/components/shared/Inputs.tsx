  ...
  return (
    <div className={cn("relative group", className)}>
      <input
        ...
        className={`peer transition-all disabled:text-neutral-600 disabled:cursor-not-allowed duration-300 delay-200 bg-neutral-100 w-full rounded-[5rem] p-8 text-[1.5rem] leading-8 placeholder:text-neutral-600 text-deep-200 outline-none border border-transparent focus:border-primary-500 disabled:border-none  ${isLoading ? "animate-pulse" : null}`}
      />
