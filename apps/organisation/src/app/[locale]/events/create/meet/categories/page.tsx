...
export default async function InPersonEventTypePage({
  ...
  // The platform was chosen a step earlier and is only carried through here.
  // Anything other than Zoom means Google Meet, which is what an online event
  // meant before Zoom existed.
