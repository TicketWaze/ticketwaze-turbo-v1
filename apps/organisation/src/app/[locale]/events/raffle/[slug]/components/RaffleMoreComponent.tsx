...
import { HamburgerMenu, MoreCircle, Trash } from "iconsax-reactjs";
import { useLocale, useTranslations } from "next-intl";
import { useRef, useState } from "react";
import RaffleDrawerContent from "./RaffleDrawerContent";
import {
  Dialog,
  DialogClose,
  DialogContent,
...
import { RequestRaffleDeletion } from "@/actions/EventActions";
...
export default function RaffleMoreComponent({
  ...
  const canDelete =
    ...
    !isPending &&
    !isDeleted;
  const graceDays = daysLeft > 0 ? Math.min(3, Math.ceil(daysLeft)) : 0;
          ...
          <div className={"flex flex-col gap-4"}>
            <li>
              <Drawer direction={"right"}>
                ...
                <RaffleDrawerContent raffle={raffle} />
              </Drawer>
            </li>
            {canDelete && (
              <li>
