        ...
        <Dialog>
          <form>
            ...
            <DialogContent className="flex flex-col gap-8 max-h-[90vh]">
              <DialogHeader>
                <DialogTitle>{t("reportOrganisation")}</DialogTitle>
              ...
              {currentStep === 1 && (
                ...
                >
                  ...
                  <label
                    ...
                    className="font-medium cursor-pointer  relative bg-neutral-100 hover:bg-zinc-100 flex items-center px-4 py-6 gap-3 rounded-[10px] text-[1.6rem] leading-8 text-deep-100 has-checked:bg-whites-[:checked]:ring-primary-500 has-checked:shadow-lg has-checked:ring-1 select-none"
                  >
                    {t("misleadingInformation")}
                    <input
                      type="radio"
